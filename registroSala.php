                ...
                <div id="content">
                    <div class="login-card" style="margin-top: 20px;">
                        ...
                        if (isset($_GET['idSala'])) {
                            require './editarSala.php';
                        } else {
                            ?>
                            <form action="insertarSala.php" method="POST">
                                <input type="text" maxlength="2" name="numero_filas" required placeholder="Numero Filas"/>
                                <input type="text" maxlength="3" name="numero_sillas" required placeholder="Numero Sillas"/>
